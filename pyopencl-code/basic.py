...
for i, p in enumerate(pf):
    print('platform[%d]:'%i, p)
    for t in [cl.device_type.ALL, cl.device_type.CPU, cl.device_type.GPU, cl.device_type.ACCELERATOR, cl.device_type.CUSTOM, cl.device_type.DEFAULT]:
        print('    0x%08x:'%t, p.get_devices(device_type=cl.device_type.ALL))
